...
if(isset($_GET['id'])) {
 ...
 <source src='teacher/videos/computer/1/".$name."'></video>";

}

?>
    <?php $sql="select *from query where vid=$id";
$result=mysqli_query($con, $sql);
...
echo '<div id="query-box">';
include('send-query.php');
echo '</div>';
?>
</body>
